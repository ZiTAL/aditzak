...
ERAMANen 123¹–125¹ orrialdeetako NNN1, NNN2 eta NNN9k egitura bera
jarraitzen dute: 116 taula-irakurketa berrikusi eta `-ramaki-/-rama- →
-ramazki-` arauaren 116 NOR pluraleko aldaera «sortua» gisa gehitu dira.
1977ko jatorrizkoak `eramaiok/eramaion` eta `eramaiek/eramaien` irakurketak
baieztatzen ditu, 1979ko OCR zalantzazkoaren aurrean.
ERAMANen 121¹–122¹ orrialdeetako NN1, NN2 eta NN9ko beste 92 irakurketa
ere auditatu dira. Partizipioaren `-n` galtzeaz sortutako `eramaitzak/-n`,
`eramaitzazu` eta `eramaitzazue` liburuak sintetiko eta elkarturik onartzen
dituenez, hitz bakarreko analizatzailean sartu dira.

ERABILIren 128¹–130¹ orrialdeetako NNN1, NNN2 eta NNN9ko 116
...
EZAGUTUren 131¹–134¹ orrialdeetako NN1, NN2, NN3, NN4 eta NN9ko 166
taula-irakurketa auditatu dira. `dazaut (= dazagut)` saila eta erroko lehen
`g`-rik gabeko erak zilegitzat ematen dituzten bi oharrek 166 azaleko forma
eta 205 analisi gramatikal eratorri sortzen dituzte; «sortua» gisa daude.
NN9ko parentesi arteko lau aukera analitikoak ez dira hitz bakarreko sarrerak.

EGINen 135¹–136¹ orrialdeetako NN1, NN2, NN3, NN4 eta NN9ko 70
taula-irakurketa auditatu dira. 1979ko azken NN9 gelaxkako `begitza`
...
IKUSIren 142¹–143¹ orrialdeetako NN1, NN2, NN3, NN4 eta NN9ko 66
taula-irakurketa auditatu dira. `a` gabeko zortzi aldaerak eta oharrean
